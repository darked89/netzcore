...
navlakha_data = False #True #False #!

DEFAULT_TOP_SCORING_CUTOFF = "1%" #"10%" #"1%" #"5%" # If ends with "%" taken as percentage otherwise as score - At the time of analysis it was "10%"
...
user_friendly_id = "biana_no_tap_relevance-new_omim" #"biana_no_tap-omim" #"all7_vs_all5-top5" # "navlakha" #"biana_no_tap" # a.k.a. emre friendly id for compare and summary
