...
user_friendly_id = "entrez-omim" #"rob_biogrid_only_genetic" #"biana_no_tap" # a.k.a. emre friendly id for compare and summary
summary_seed_cutoff = None #1 #None #20 # Seed cutoff considered for inclusion of an experiment in sum_up_experiments, if None seed.dat is not created
...
#ppis += ["biana_no_tap_no_reliability_permuted_p70_53"]
...
#phenotypes += [ "perturbed_%s_p%i_%i" % (d, p, i) for d in omim_phenotypes for p in xrange(10,100,10) for i in xrange(1,11) ]
