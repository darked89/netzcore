...
user_friendly_id = "biana_no_tap-omim-cfinder" #"biana_no_tap_relevance-new_omim_aids-gad_function" #goh-omim_w_LI" #"biana_no_tap-omim" #"all7_vs_all5-top5" # "navlakha" #"biana_no_tap" # a.k.a. emre friendly id for compare and summary
